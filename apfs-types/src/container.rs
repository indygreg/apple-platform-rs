...
pub struct ContainerSuperblockRaw {
    ...
    compatible_features: ContainerCompatibleFeaturesRaw,
    ...
    readonly_compatible_features: ContainerReadonlyCompatibleFeaturesRaw,
    ...
    incompatible_features: ContainerIncompatibileFeaturesRaw,
    ...
    #[cfg_attr(feature = "derive", apfs(copied))]
    next_transaction_identifier: TransactionIdentifierRaw,
    ...
    #[cfg_attr(feature = "derive", apfs(copied))]
    checkpoint_descriptor_area_block_number: PhysicalAddressRaw,
    ...
    #[cfg_attr(feature = "derive", apfs(copied))]
    checkpoint_data_area_block_number: PhysicalAddressRaw,
    ...
    checkpoint_descriptor_area_next_available_index: u32,
    ...
    blocked_out_prange: PhysicalAddressRangeRaw,
    ...
    #[cfg_attr(feature = "derive", apfs(copied))]
    efi_jumpstart: PhysicalAddressRaw,
    ...
    ephemeral_info: [u64; CONTAINER_EPHEMERAL_INFO_COUNT],
    ...
    #[cfg_attr(feature = "derive", apfs(copied))]
    test_identifier: ObjectIdentifierRaw,
    ...
    #[cfg_attr(feature = "derive", apfs(copied))]
    fusion_middle_tree_block_number: PhysicalObjectIdentifierRaw,
    ...
    #[cfg_attr(feature = "derive", apfs(copied))]
    fusion_writeback_cache_identifier: EphemeralObjectIdentifierRaw,

    /// The blocks used for the Fusion write-back cache area (`nx_fusion_wbc`).
    ///
    /// 0 for non-Fusion drives.
    fusion_writeback_cache: PhysicalAddressRangeRaw,
    ...
    mkb_locker: PhysicalAddressRangeRaw,
}
...
pub struct CheckpointMappingRaw {
    ...
    #[cfg_attr(feature = "derive", apfs(copied))]
    object_type: ObjectTypeValueRaw,
    /// The object's subtype (`cpm_subtype`).
    #[cfg_attr(feature = "derive", apfs(copied))]
    object_subtype: ObjectTypeValueRaw,
    ...
    #[cfg_attr(feature = "derive", apfs(copied))]
    filesystem_identifier: VirtualObjectIdentifierRaw,
    /// The object identifier (`cpm_oid`).
    #[cfg_attr(feature = "derive", apfs(copied))]
    container_identifier: EphemeralObjectIdentifierRaw,
...
pub struct EvictMappingValueRaw {
    ...
    #[cfg_attr(feature = "derive", apfs(copied))]
    destination_address: PhysicalAddressRaw,
